...
```{r, echo=FALSE, out.width = '85%', out.height='90%'}
...
plot(y[[1]][test], type ="l", col = "blue",
     ...
     xlab = "Last 50 Days",
     main = "RNN Forecasting for Covid-19 Cases - in differeces")
...
```{r, echo=FALSE, out.width = '75%', out.height='80%'}
...
Now, we return to the application of LSTM to our COVID-19 data.  We use the "Adam" optimization algorithm, which is an extension to stochastic gradient descent and works with LSTM very well.  
...
Different than RNN we built before, we experimented a different (arbitrary) netwotk with LSTM.
