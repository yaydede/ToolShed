...
The polynomial regression is based on fixed components, or bases: $x, x^2, x^3, \ldots, x^M.$  ANN replaces these fixed components with adjustable ones or bases: $f\left(\alpha_1+\delta_1 x\right)$, $f\left(\alpha_2+\delta_2 x\right)$, $\ldots, f\left(\alpha_M+\delta_M x\right).$  
