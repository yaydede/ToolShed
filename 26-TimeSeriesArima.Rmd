...
- Integrated (I) component: This component component refers to the degree of differencing that is applied to the time series data. The degree of differencing (d) is the number of times that the data is differenced in order to make it stationary (meaning that the mean and variance are constant over time). 
